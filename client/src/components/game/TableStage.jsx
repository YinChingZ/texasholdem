...
export default function TableStage({ gameState, seatEvents = {}, boardReveal, potFlights = [], revealedHands = {}, currentUserId, isSpectator, privateCards = [], livePlayer, tableAwards = {} }) {
